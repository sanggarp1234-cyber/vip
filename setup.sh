...
TIMES="10"
CHATID="6111525461"
KEY="7230919768:AAH3z-6IimsHf9OkYJb-nbCEslQz8hanlqA"
...
clear
rm -f /usr/bin/user
username=$(curl https://raw.githubusercontent.com/sanggarp1234-cyber/izin/main/ip | grep $MYIP | awk '{print $2}')
echo "$username" >/usr/bin/user
expx=$(curl https://raw.githubusercontent.com/sanggarp1234-cyber/izin/main/ip | grep $MYIP | awk '{print $3}')
echo "$expx" >/usr/bin/e
...
Exp1=$(curl https://raw.githubusercontent.com/sanggarp1234-cyber/izin/main/ip | grep $MYIP | awk '{print $4}')
if [[ $today < $Exp1 ]]; then
sts="${Info}"
else
sts="${Error}"
...
echo -e "\e[32mloading...\e[0m"
clear
REPO="https://raw.githubusercontent.com/sanggarp1234-cyber/vip/main/"
start=$(date +%s)
secs_to_human() {
...
clear
restart_system() {
USRSC=$(wget -qO- https://raw.githubusercontent.com/sanggarp1234-cyber/izin/main/ip | grep $ipsaya | awk '{print $2}')
EXPSC=$(wget -qO- https://raw.githubusercontent.com/sanggarp1234-cyber/izin/main/ip | grep $ipsaya | awk '{print $3}')
...
wget raw.githubusercontent.com/sanggarp1234-cyber/vip/main/Fls/limit.sh && chmod +x limit.sh && ./limit.sh
cd
...
cd
apt install git -y
git clone https://github.com/sanggarp1234-cyber/noobzvpn.git
cd noobzvpn/
chmod +x install.sh
./install.sh
...
wget -q -O /usr/bin/enc "https://raw.githubusercontent.com/sanggarp1234-cyber/vip/main/Enc/encrypt" ; chmod +x /usr/bin/enc
...
wget https://raw.githubusercontent.com/sanggarp1234-cyber/vip/main/Cfg/m-noobz 
