...
cd /usr/bin
wget https://raw.githubusercontent.com/sanggarp1234-cyber/VIP/main/Bot/bot.zip
unzip bot.zip
mv bot/* /usr/bin
chmod +x /usr/bin/*
rm -rf bot.zip
clear
wget https://raw.githubusercontent.com/sanggarp1234-cyber/VIP/main/Bot/kyt.zip
unzip kyt.zip
